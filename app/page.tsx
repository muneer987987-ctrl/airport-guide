...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative h-[600px] flex items-center justify-center overflow-hidden bg-ink-900">
        ...
        <div className="relative z-10 container-guide text-center">
          ...
          <p className="text-lg text-ink-200 max-w-2xl mx-auto mb-10">
            Terminal maps, lounges, parking, transfers, and live flight status — everything you need before you fly.
          </p>
      ...
      <section className="py-20 bg-white dark:bg-ink-900">
        <div className="container-guide">
          <div className="flex items-center justify-between mb-10">
            ...
            <Link href="/search" className="flex items-center gap-2 text-signal hover:underline">
      ...
      <section className="py-20 bg-white dark:bg-ink-900">
        <div className="container-guide">
          <h2 className="font-display text-3xl font-bold text-center text-ink-900 dark:text-white mb-4">
            Trusted by Travelers Worldwide
          </h2>
          <p className="text-center text-ink-500 mb-12 max-w-2xl mx-auto">
            See what our community has to say about their airport experiences
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <TestimonialCard 
              name="Sarah M."
              role="Business Traveler"
              text="This site saved me during a 6-hour layover in Dubai. Found the perfect lounge!"
              rating={5}
            />
            <TestimonialCard 
              name="Ahmed K."
              role="Backpacker"
              text="The terminal maps are incredibly detailed. Never got lost again at any airport."
              rating={5}
            />
            <TestimonialCard 
              name="Lisa T."
              role="Family Traveler"
              text="Found family-friendly amenities at every airport we visited. Highly recommend!"
              rating={5}
            />
          </div>
        </div>
        ...
        <div className="container-guide">
          <div className="flex items-center justify-between mb-10">
            <div>
              ...
              <p className="mt-2 text-ink-500">Latest from our blog</p>
            </div>
            <Link href="/blog" className="flex items-center gap-1 text-signal hover:underline">
              View all <ArrowRight className="w-4 h-4" />
            </Link>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <BlogCard 
              title="10 Tips for Long Layovers"
              excerpt="Make the most of your waiting time with these expert tips for comfortable layovers."
              date="July 20, 2026"
              image="/blog/layover.jpg"
            />
            <BlogCard 
              title="Best Airport Lounges 2026"
              excerpt="Our top picks for premium lounge experiences worldwide. Worth every penny!"
              date="July 15, 2026"
              image="/blog/lounges.jpg"
            />
            <BlogCard 
              title="Navigating Heathrow Like a Pro"
              excerpt="Complete guide to London's busiest airport. Terminals, transfers, and more."
              date="July 10, 2026"
              image="/blog/heathrow.jpg"
            />
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-signal">
        <div className="container-guide text-center">
          ...
          <p className="text-white/80 mb-8 max-w-md mx-auto">
            Get airport tips, deals, and news delivered to your inbox weekly.
          </p>
          <form className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
            <input
              type="email"
              placeholder="Enter your email"
              className="flex-1 px-4 py-3 rounded-lg text-ink-900 outline-none focus:ring-2 focus:ring-white"
            />
